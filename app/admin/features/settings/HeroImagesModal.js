    ...
    <Dialog open={open} onClose={busy ? undefined : onClose} fullWidth maxWidth="sm">
      ...
      <DialogContent dividers>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          Extra homepage hero photo(s). The first image in this list is used on
          the hero (after an optional General “first hero” star). Suite photos
          are never used here. For the property gallery strip, use General
          photos.
        </Typography>
